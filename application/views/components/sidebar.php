<ul class="navbar-nav pt-lg-3">
	...
	<li class="nav-item <?= $this->uri->uri_string() == 'transaction/order' ? 'active' : '' ?>">
	...
	<li class="nav-item <?= $this->uri->uri_string() == 'transaction/payment' ? 'active' : '' ?>">
		<a class="nav-link" href="<?= base_url('transaction/payment') ?>">
			<span class="nav-link-icon d-md-none d-lg-inline-block">
				<!-- Download SVG icon from http://tabler-icons.io/i/home -->
