...
<!--						</a>-->
					...
					<div class="nav-item dropdown">
						<a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
							...
							<span class="avatar avatar-sm"
								style="background-image: url(<?= base_url('assets/dist/img/face.png') ?>)"></span>
							<div class="d-none d-xl-block ps-2">
								<div><?= ucfirst($this->auth->user()->first_name) ?>></div>
								<div class="mt-1 small text-muted"><?= $this->auth->user()->role_id == 1 ? 'Administrator' : 'Member' ?>></div>
							</div>
						</a>
	...
	<audio id="notification-sound">
		<source src="<?= base_url('assets/dist/notification.mp3'); ?>" type="audio/mpeg">
	</audio>
	...
	<script src="<?= base_url('assets/dist/js/notification/notification.js') ?>" defer></script>
</body>
